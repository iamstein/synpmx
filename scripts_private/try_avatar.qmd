...
vignette for the decision rule.

Run this in the safe computing environment. Both the synthetic table and the
comparison figure are source-derived and stay here.
...
raw   <- PREP(read.csv(DATA_PATH, stringsAsFactors = FALSE))
roles <- ROLES
...
if (requireNamespace("ggplot2", quietly = TRUE)) {
  ...
  ggplot2::ggplot(compare, ggplot2::aes(time, dv, group = id)) +
    ...
    ggplot2::theme_bw()
  # Concentrations often read better on a log axis. Add `+ scale_y_log10()`
  # above if every DV is positive; a log scale drops zeros and negatives.
} else {
