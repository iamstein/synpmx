...
## Fixtures and simulated studies

Fully public example datasets for testing and demonstration, and two
simulated studies with the truth known: one dosed by two routes, one
shaped like an oncology trial with crossover, dose reduction and
...
- [`onc_sim`](https://iamstein.github.io/synpmx/reference/onc_sim.md) :
  A simulated oncology study with crossover, dose reduction and
  compressed doses
