...
| `public-data-examples.Rmd` | `synpmx_avatar()` measured over every public dataset in the evaluation set, one section each plus the cross-dataset tables. Opens with a table describing every dataset used. Plot helpers hidden behind code folding. Renamed from `synpmx-demo.Rmd` 2026-08-04. |
