...
This is a privacy question and `synpmx` offers four options.  

The main deliverable of the package uses an implementation of the AVATAR method which offers some blinding, but not formal privacy guarantees.  The AVATAR method works by blending together actual patient profiles and does not requiring specification of a model.
