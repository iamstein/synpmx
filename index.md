...
time of DV collection pattern held by fewer than `min_pattern_share`
subjects is **lost, not approximated**, and instead such a pattern is
sampled from the patients who share this data collection patterns with
others .
