---
title: "Mechanism-level privacy argument"
---
...
`synpmx_empirical()` is the only exported synthesis function that accepts source
...
`synpmx_generate()`, `validate_private_model()`, `privacy_report()`, and generated-
...
organizational governance. Repeated `synpmx_generate()` calls against one
release consume no additional budget.
