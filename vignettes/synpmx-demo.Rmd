...
`nimoData` has ten approximately weekly infusions, declared OCC/TAD, a nominal
dose group (`DOS`), and a time-varying weight column that is excluded. The dose
group is carried as a subject property.
...
occasion, an occasion-varying assigned `DOSE`, numeric-coded `SEX`, and infusion
