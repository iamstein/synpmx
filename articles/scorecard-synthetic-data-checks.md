...
Nothing fails on either. The rest of this vignette is what each check
asks, why its pass criterion is what it is, and where `pheno_sd` is
worse than its card suggests.
