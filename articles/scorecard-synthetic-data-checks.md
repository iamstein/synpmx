...
| **B5** | Does any categorical level sit on a single synthetic patient? | [`synpmx_scorecard()`](https://iamstein.github.io/synpmx/reference/synpmx_scorecard.md); `table(synthetic$COLUMN)` | synthetic | no level on one patient — *review*, since this is the weak form of the check |
