...
#>   released subject count: 82.8
#>   pk correction: 2.25x
#>   corrected typical: cl=4.49, v=10, ka=0.5
...
#>  $ TIME : num  0 0 1.04 2.04 3.09 ...
#>  $ NTIME: num  0 0 1 2 3 7 7 8 9 10 ...
#>  $ DV   : num  NA 0 3.24 3.68 3.18 ...
...
#>   .. .. .. ..$ span  : num 2.77
#>   .. .. .. ..- attr(*, "class")= chr "pmx_prior"
#>   ..$ corrected_typical    : Named num [1:3] 4.49 10 0.5
#>   .. ..- attr(*, "names")= chr [1:3] "cl" "v" "ka"
#>   ..$ private_subject_count: num 82.8
#>   ..$ preflight            :List of 6
#>   .. ..$ d         : int 2
#>   .. ..$ epsilon   : num 0.1
#>   .. ..$ n_subjects: num 82.8
...
#>   ..$ ledger               :List of 5
#>   .. ..$ release_id       : chr "pmx-20260912T210110.682433-20984"
#>   .. ..$ created_utc      : chr "2026-09-12T21:01:10.682704Z"
