...
![](avatar-public-data-examples_files/figure-html/case1-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(case1_pkpd, case1_synth, case1_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/mad-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/mad-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(mad, mad_synth, mad_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/theo-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/theo-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(theo_md, theo_synth, theo_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/warfarin-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/warfarin-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(warfarin, warfarin_synth, warfarin_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/wbc-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/wbc-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(wbcSim, wbc_synth, wbc_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/nimo-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/nimo-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(nimoData, nimo_synth, nimo_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/nimo-schedule-1.png)
...
![](avatar-public-data-examples_files/figure-html/nimo-schedule-2.png)
...
![](avatar-public-data-examples_files/figure-html/nimo-fixed-schedule-1.png)
...
![](avatar-public-data-examples_files/figure-html/mavo-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/mavo-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(mavoglurant, mavo_synth, mavo_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/pheno-plot-1.png)
...
![](avatar-public-data-examples_files/figure-html/pheno-distributions-1.png)

``` r

synpmx_scorecard_datatable(synpmx_scorecard(pheno_sd, pheno_synth, pheno_roles),
                           report = "minimal")
```
...
![](avatar-public-data-examples_files/figure-html/pheno-schedule-1.png)
...
![](avatar-public-data-examples_files/figure-html/pheno-schedule-2.png)
...
synpmx_scorecard_datatable(synpmx_scorecard(mixroute_sim, mixroute_synth, mixroute_roles),
                           report = "minimal")
```
...
synpmx_scorecard_datatable(synpmx_scorecard(onc_sim, onc_synth, onc_roles),
                           report = "minimal")
```
