...
endpoint’s profile is evaluated against its own drug’s doses, and the
generated study writes both drugs’ dose records back with their own
`adm` value and compartment. Undeclared,
[`model_report()`](https://iamstein.github.io/synpmx/reference/model_report.md)
