...
# endpoint with a type for a value, and `routes` and `dose_endpoints` are keyed
# by administration id with a route and an endpoint name for a value -- the
# column both describe is `adm`, which is here.
